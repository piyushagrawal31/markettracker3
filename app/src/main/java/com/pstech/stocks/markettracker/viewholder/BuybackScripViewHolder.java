...
import static com.pstech.stocks.markettracker.utils.AppConstants.processInt;
import static com.pstech.stocks.markettracker.utils.AppConstants.processString;

public class BuybackScripViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
...
//    @BindView(R.id.issue_type) TextView issueTypeView;
    ...
    public BuybackScripViewHolder(View itemView, Context context) {
        super(itemView);
    ...
    public void bindToPost(BuybackScrip post, View.OnClickListener starClickListener) {
